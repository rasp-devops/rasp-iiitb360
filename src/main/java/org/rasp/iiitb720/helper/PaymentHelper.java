 ...
 */
 public class PaymentHelper extends BaseHelper {
		public PaymentHelper() {super(new Payment());}
		private static PaymentHelper instance;
		public static PaymentHelper getInstance() {if (instance == null)	{instance = new PaymentHelper();register_birecord();} return instance;}
