 ...
 */
 public class NotificationHelper extends BaseHelper {
		public NotificationHelper() {super(new Notification());}
		private static NotificationHelper instance;
		public static NotificationHelper getInstance() {if (instance == null)	{instance = new NotificationHelper();register_birecord();} return instance;}
