 ...
 * 
 */
public class Availability extends BaseResource {
	...
	public static String FIELD_INTERFACE_ID = "interface_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("availability");
	...
	static {
		...
		Field interface_idField = new Field("interface_id", "String");
		interface_idField.setIndexed(true);
		interface_idField.setForeign(new Foreign("interface"));
		interface_idField.setLength(128);
		metaData.addField(interface_idField);
		...
		metaData.setTableName("availability");

		metaData.setCluster("DB_PROFILE");
	}

	public Availability() {this.setId(Util.getUniqueId());}
	public Availability(String id) {this.setId(id);}

	public Availability(Availability obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		interface_id = (String) map.get("interface_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object interface_idObj = map.get("interface_id");
		if(interface_idObj != null)
			interface_id = interface_idObj.toString();
	...
	public String getInterface_idEx() {
		return interface_id != null ? interface_id : "";
	}
	...
	public  Class<?> getResultClass() {return AvailabilityResult.class;};
	public  Class<?> getMessageClass() {return AvailabilityMessage.class;};
	public  Class<?> getHelperClass() {return AvailabilityHelper.class;};
	public  Class<?> getServiceClass() {return AvailabilityService.class;};
}