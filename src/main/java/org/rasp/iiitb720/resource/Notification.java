 ...
 * 
 */
public class Notification extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("notification");
	...
	public Notification() {this.setId(Util.getUniqueId());}
	public Notification(String id) {this.setId(id);}

	public Notification(Notification obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return NotificationResult.class;};
	public  Class<?> getMessageClass() {return NotificationMessage.class;};
	public  Class<?> getHelperClass() {return NotificationHelper.class;};
	public  Class<?> getServiceClass() {return NotificationService.class;};
}