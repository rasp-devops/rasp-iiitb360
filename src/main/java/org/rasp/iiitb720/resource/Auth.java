...
public class Auth extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("auth");
	...
	static {
		...
		metaData.setTableName("auth");

		metaData.setCluster("DB_PROFILE");
	}

	public Auth() {this.setId(Util.getUniqueId());}
	public Auth(String id) {this.setId(id);}
	...
	public  Class<?> getResultClass() {return AuthResult.class;};
	public  Class<?> getMessageClass() {return AuthMessage.class;};
	public  Class<?> getHelperClass() {return AuthHelper.class;};
	public  Class<?> getServiceClass() {return AuthService.class;};
}