...
public class Payment extends BaseResource {
	...
	public static String FIELD_RESERVATION_ID = "reservation_id";
	public static String FIELD_AUTH_ID = "auth_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("payment");
	...
	static {
		...
		Field reservation_idField = new Field("reservation_id", "String");
		reservation_idField.setIndexed(true);
		reservation_idField.setForeign(new Foreign("reservation"));
		reservation_idField.setLength(128);
		metaData.addField(reservation_idField);

		Field auth_idField = new Field("auth_id", "String");
		auth_idField.setIndexed(true);
		auth_idField.setForeign(new Foreign("auth"));
		auth_idField.setLength(128);
		metaData.addField(auth_idField);
		...
		metaData.setTableName("payment");

		metaData.setCluster("DB_PROFILE");
	}

	public Payment() {this.setId(Util.getUniqueId());}
	public Payment(String id) {this.setId(id);}
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		reservation_id = (String) map.get("reservation_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object reservation_idObj = map.get("reservation_id");
		if(reservation_idObj != null)
			reservation_id = reservation_idObj.toString();

		Object auth_idObj = map.get("auth_id");
		if(auth_idObj != null)
			auth_id = auth_idObj.toString();
	...
	public String getReservation_idEx() {
		return reservation_id != null ? reservation_id : "";
	}
	...
	public  Class<?> getResultClass() {return PaymentResult.class;};
	public  Class<?> getMessageClass() {return PaymentMessage.class;};
	public  Class<?> getHelperClass() {return PaymentHelper.class;};
	public  Class<?> getServiceClass() {return PaymentService.class;};
}