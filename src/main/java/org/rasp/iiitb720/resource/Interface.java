...
public class Interface extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("interface");
	...
	static {
		...
		metaData.setTableName("interface");

		metaData.setCluster("DB_PROFILE");
	}

	public Interface() {this.setId(Util.getUniqueId());}
	public Interface(String id) {this.setId(id);}

	public Interface(Interface obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return InterfaceResult.class;};
	public  Class<?> getMessageClass() {return InterfaceMessage.class;};
	public  Class<?> getHelperClass() {return InterfaceHelper.class;};
	public  Class<?> getServiceClass() {return InterfaceService.class;};
}